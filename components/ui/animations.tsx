...
export function GlowPulse({ children, color = "yellow", className }: GlowPulseProps) {
  const colorClasses = {
...
export function EliminationFlash({ children, active = false, className }: EliminationFlashProps) {
  return (
    <div
      className={cn(
