        ...
        extend: {
            ...
            keyframes: {
                ...
                glowPulseYellow: {
                    ...
                    "50%": {
                        boxShadow:
                            "0 0 20px rgba(250, 204, 21, 0.6), 0 0 30px rgba(250, 204, 21, 0.4)",
                    },
                    "100%": {
                        boxShadow: "0 0 5px rgba(250, 204, 21, 0.3)",
                    },
                ...
                glowPulsePink: {
                    ...
                    "50%": {
                        boxShadow:
                            "0 0 20px rgba(255, 20, 147, 0.6), 0 0 30px rgba(255, 20, 147, 0.4)",
                    },
                    "100%": {
                        boxShadow: "0 0 5px rgba(255, 20, 147, 0.3)",
                    },
                ...
                glowPulseGreen: {
                    ...
                    "50%": {
                        boxShadow:
                            "0 0 20px rgba(0, 255, 0, 0.6), 0 0 30px rgba(0, 255, 0, 0.4)",
                    },
                    "100%": {
                        boxShadow: "0 0 5px rgba(0, 255, 0, 0.3)",
                    },
            ...
            animation: {
                ...
                "player-glow":
                    "player-glow 1.5s ease-in-out infinite alternate",
